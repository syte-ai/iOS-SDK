//
//  EventShopTheLookOfferClick.swift
//  Syte
//
 ...
 */
public class EventShopTheLookOfferClick: BaseSyteEvent {
    ...
    public init(sku: String, position: Int, pageName: String) {
        ...
        super.init(name: "fe_offer_click", syteUrlReferer: pageName, tag: .shopTheLook)
    }
